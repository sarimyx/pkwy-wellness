    ...
    return (
        <div className="relative w-full py-8 my-8">
            ...
            <div className="relative flex justify-center">
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        <div className="w-3 h-3 bg-gradient-to-br from-orange-400 to-purple-500 rounded-full shadow-lg animate-pulse" style={{ animationDelay: '0.8s' }}></div>
                        <div className="absolute inset-0 w-3 h-3 bg-gradient-to-br from-orange-300/30 to-purple-400/30 rounded-full blur-sm animate-pulse" style={{ animationDelay: '0.8s' }}></div>
                    </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-8 bg-gradient-to-r from-orange-200/10 via-purple-200/5 to-orange-200/10 rounded-full blur-xl"></div>
            </div>
        </div>
    );
}
